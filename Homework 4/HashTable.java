...
public class HashTable<E, S>
{
    ...
    public boolean insert( E x, S r)
    {
        ...
        array[ currentPos ] = new HashEntry<>( x, r, true );
    ...
    private void rehash( )
    {
        ...
        for( HashEntry<E> entry : oldArray )
            if( entry != null && entry.isActive )
                insert( entry.element, entry.record);
    }
    ...
    private class HashEntry<E>
    {
        ...
        public S record;   // the record
        public boolean isActive;  // false if marked deleted

        public HashEntry( E e, S r )
        {
            this( e, r, true );
        }

        public HashEntry( E e, S r, boolean i )
        {
            element  = e;
            record = r;
            isActive = i;
